...
| 2026-05-28 | #1022/#1023 (backfill) | contract+verify-pr+hook | high | proposed | N | [backfill-pr1022-claim-drift](2026-05-28-backfill-pr1022-claim-drift.md) | "removes SignInModalHostingController" PR-body claim never reconciled with diff; propagated from #1022 to stacked #1023. M1 reconciler catches it mechanically. |
| 2026-05-28 | #1020 (backfill) | blast-radius+verify-pr+hook | high | proposed | N | [backfill-pr1020-blast-radius](2026-05-28-backfill-pr1020-blast-radius.md) | 7 new `public` declarations on `Palace/Audiobooks/PlaybackReadinessGate.swift` (critical-path). Would have block-always under M1 pre-commit floor. |
| 2026-05-28 | #1018 (backfill) | blast-radius+verify-pr | high | proposed | N | [backfill-pr1018-blast-radius](2026-05-28-backfill-pr1018-blast-radius.md) | Auth-architecture PR landed ~19 new `public` declarations on main-target files (AuthDecisionEvent/Recorder, TPPReauthenticator extension). SPM-source `public` ≈30 false positives noted. |
