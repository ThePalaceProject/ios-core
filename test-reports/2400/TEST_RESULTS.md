...
**Generated:** 2026-04-01 17:39:26 UTC
**Commit:** `58ea3a9bc452`
**Branch:** `hotfix/lcp-content-protection-redownload`
...
Unable to find a destination matching the provided destination specifier:
		{ platform:iOS Simulator, OS:latest, name:iPhone 16e }

	Ineligible destinations for the "Palace" scheme:
		{ platform:iOS, id:dvtdevice-DVTiPhonePlaceholder-iphoneos:placeholder, name:Any iOS Device, error:iOS 26.4 is not i...
```
