...
**Generated:** 2026-06-30 02:05:09 UTC
**Commit:** `98f9c613b485`
**Branch:** `feat/swift6-palacetriagebot`
...
Conformance of 'EmailTicketGateway' to protocol 'MFMailComposeViewControllerDelegate' crosses into main actor-isolated code and can cause data races
```
