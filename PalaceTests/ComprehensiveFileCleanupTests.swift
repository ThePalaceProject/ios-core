...
final class ComprehensiveFileCleanupTests: XCTestCase {
    ...
    func testComprehensiveCleanupDoesNotAffectOtherBooks() {
        ...
        XCTAssertGreaterThanOrEqual(otherBookFilesAfter.count, otherBookFilesBefore.count * 0.8, 
    ...
    private func cleanupTestFiles() {
        ...
        guard let testBookId = testBookId else { return }
...
// MARK: - AudiobookDataManager Tests
