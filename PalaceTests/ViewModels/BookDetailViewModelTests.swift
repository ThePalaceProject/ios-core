...
final class BookDetailViewModelTests: XCTestCase {
    ...
    func testViewModel_UpdatesBookWhenRegistryChanges() {
        ...
        let viewModel = BookDetailViewModel(book: initialBook, registry: mockRegistry, downloadCenter: .shared, accountsManager: .shared, settings: .shared, opdsFeedService: .shared, samplePreviewManager: .shared, readerService: .shared)
    ...
    func testViewModel_ReceivesBookFromRegistry_NotCachedVersion() {
        ...
        let viewModel = BookDetailViewModel(book: originalBook, registry: mockRegistry, downloadCenter: .shared, accountsManager: .shared, settings: .shared, opdsFeedService: .shared, samplePreviewManager: .shared, readerService: .shared)
    ...
    private func makeVM(state: TPPBookState = .unregistered) -> (BookDetailViewModel, TPPBookRegistryMock, TPPBook) {
        ...
        let vm = BookDetailViewModel(book: book, registry: registry, downloadCenter: .shared, accountsManager: .shared, settings: .shared, opdsFeedService: .shared, samplePreviewManager: .shared, readerService: .shared)
