...
final class SettingsViewModelTests: XCTestCase {
    ...
    override func setUp() {
        ...
        sut = SettingsViewModel(settings: mockSettings, accountsManager: makeTestAppContainer().accountsManager)
        cancellables = []
    }
    ...
    func testSettingsViewModel_Init_ReadsSettingsFromProvider() async {
        ...
        // Act
        let viewModel = SettingsViewModel(settings: mockSettings, accountsManager: makeTestAppContainer().accountsManager)
