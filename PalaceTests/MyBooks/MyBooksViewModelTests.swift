...
private func makeViewModel() -> MyBooksViewModel {
    MyBooksViewModel(bookRegistry: TPPBookRegistryMock(), accountsManager: .shared, settings: .shared, downloadCenter: .shared)
}
...
final class GroupEnumTests: XCTestCase {
    ...
    func testGroup_UsedAsSection_FacetViewModelGroupNameMatches() {
        let vm = MyBooksViewModel(bookRegistry: TPPBookRegistryMock(), accountsManager: .shared, settings: .shared, downloadCenter: .shared)
...
final class MyBooksViewModelExtendedTests: XCTestCase {
    ...
    func testFilterBooks_WithEmptyQuery_RestoresAllBooks() async {
        ...
        let viewModel = MyBooksViewModel(bookRegistry: mock, accountsManager: .shared, settings: .shared, downloadCenter: .shared)
