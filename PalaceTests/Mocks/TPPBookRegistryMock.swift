...
@objc class TPPBookRegistryMock: NSObject, TPPBookRegistrySyncing, TPPBookRegistryProvider {
...
//  // MARK: - Mock Data
//  private var registry = [String: TPPBookRegistryRecord]() {
//    didSet { registrySubject.send(registry) }
//  }
//
//  var allBooks: [TPPBook] {
//    registry.values.map { $0.book }
//  }
//
//  // MARK: - Book Management
...
//  // MARK: - Cover Image
//  func coverImage(for book: TPPBook, handler: @escaping (UIImage?) -> Void) {
//    handler(UIImage(systemName: "book"))
//  }
//
//  // MARK: - Fulfillment ID
//  func fulfillmentId(forIdentifier bookIdentifier: String?) -> String? {
