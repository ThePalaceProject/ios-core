...
final class TPPBookRegistryStateManagementTests: XCTestCase {
    ...
    private var registry: TPPBookRegistry { makeTestAppContainer().bookRegistry as! TPPBookRegistry }
}
...
final class TPPBookRegistryLocationTests: XCTestCase {
    ...
    func testLocation_ForNonExistentBook_ReturnsNil() {
        let nonExistentId = "non-existent-\(UUID().uuidString)"
        XCTAssertNil(makeTestAppContainer().bookRegistry.location(forIdentifier: nonExistentId))
        XCTAssertEqual(makeTestAppContainer().bookRegistry.state(for: nonExistentId), .unregistered,
...
final class TPPBookRegistryBookmarkTests: XCTestCase {
    ...
    func testReplaceGenericBookmark_UpdatesBookmark() {        let registry = makeTestAppContainer().bookRegistry as! TPPBookRegistry
...
final class TPPBookRegistryFulfillmentIdTests: XCTestCase {
    ...
    func testFulfillmentId_ForNilIdentifier_ReturnsNil() {
        XCTAssertNil(makeTestAppContainer().bookRegistry.fulfillmentId(forIdentifier: nil))
    }

    func testFulfillmentId_ForEmptyIdentifier_ReturnsNil() {
        XCTAssertNil(makeTestAppContainer().bookRegistry.fulfillmentId(forIdentifier: ""))
    }

    func testFulfillmentId_ForNonExistentBook_ReturnsNil() {
        XCTAssertNil(makeTestAppContainer().bookRegistry.fulfillmentId(forIdentifier: "non-existent-book"))
    }
}
...
final class TPPBookRegistryBookRetrievalTests: XCTestCase {
    ...
    func testBook_ForNilIdentifier_ReturnsNil() {
        XCTAssertNil(makeTestAppContainer().bookRegistry.book(forIdentifier: nil))
        XCTAssertEqual(makeTestAppContainer().bookRegistry.state(for: nil), .unregistered,
                       "nil identifier must map to unregistered state")
    }

    func testBook_ForEmptyIdentifier_ReturnsNil() {
        XCTAssertNil(makeTestAppContainer().bookRegistry.book(forIdentifier: ""))
        XCTAssertEqual(makeTestAppContainer().bookRegistry.state(for: ""), .unregistered,
    ...
    func testBook_ForNonExistentIdentifier_ReturnsNil() {
        ...
        XCTAssertNil(makeTestAppContainer().bookRegistry.book(forIdentifier: id))
        XCTAssertEqual(makeTestAppContainer().bookRegistry.state(for: id), .unregistered,
