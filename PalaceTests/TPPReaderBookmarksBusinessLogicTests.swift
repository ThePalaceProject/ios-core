...
class TPPReaderBookmarksBusinessLogicTests: XCTestCase {
  ...
  func testUpdateLocalBookmarksWithNoLocalBookmarks() throws {
    ...
    guard let firstBookmark = newBookmark(
      href: "Intro",
      chapter: "1",
    ...
    bookmarkBusinessLogic.updateLocalBookmarks(
      serverBookmarks: serverBookmarks,
      localBookmarks: bookRegistryMock
        .readiumBookmarks(forIdentifier: bookIdentifier),
  ...
  func testUpdateLocalBookmarksWithDuplicatedLocalBookmarks() throws {
    ...
    guard let firstBookmark = newBookmark(
      ...
      let secondBookmark = newBookmark(
        href: "Intro",
        chapter: "1",
    ...
    XCTAssertEqual(bookRegistryMock.readiumBookmarks(forIdentifier: bookIdentifier).count, 1)
