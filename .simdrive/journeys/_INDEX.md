...
| [PP-4529-print-page-navigation-voiceover](PP-4529-print-page-navigation-voiceover.yaml) | stateful | 13 | PP-4529 print-page nav (DAISY nav-110) accessibility journey — positions-sheet **Pages** tab + **Go to Page** prompt + **Page Not Found** path are OCR-observable via simdrive; the post-seek VoiceOver **arrival announcement** ("Page N") is a DEVICE-ONLY audio claim (3 `device_only_claims`, reported UNVERIFIED pending a hardware VoiceOver pass). `status: staged` — observe-driven, not yet recorded. |
