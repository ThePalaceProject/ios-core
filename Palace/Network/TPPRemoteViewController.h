...
/// |TPPRemoteViewController| can be told to load the data present at some URL. While the data is
...
/// added as a child vc by the instance of |TPPRemoteViewController|.
///
...
@interface TPPRemoteViewController : UIViewController
...
- (instancetype)initWithURL:(NSURL *)URL
                    handler:(UIViewController *(^)(TPPRemoteViewController *remoteViewController,
                                                   NSData *data,
