...
//  Palace
//
//  Created by Vladimir Fedorov on 03.12.2021.
  ...
  var stringByDecodingHTMLEntities: String {
    ...
    func decode(_ entity: Substring) -> Character? {
      if entity.hasPrefix("&#x") || entity.hasPrefix("&#X") {
        decodeNumeric(entity.dropFirst(3).dropLast(), base: 16)
      } else if entity.hasPrefix("&#") {
        decodeNumeric(entity.dropFirst(2).dropLast(), base: 10)
      } else {
...
extension NSString {
  ...
  func stringByDecodingHTMLEntities() -> NSString {
    (self as String).stringByDecodingHTMLEntities as NSString
  }
}
