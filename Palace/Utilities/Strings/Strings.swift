...
struct Strings {
  ...
  struct Error {
    ...
    static let epubNotValidError = NSLocalizedString("The book you were trying to read is corrupted. Please try downloading it again.", comment: "Error message when trying to read an EPUB that is invalid").localized
  ...
  struct Generic {
    static let back = NSLocalizedString("Back", comment: "Text for Back button").localized
    ...
    static let close = NSLocalizedString("Close", comment: "").localized
  }
  ...
  struct TPPBaseReaderViewController {
    ...
    static let addBookmark = NSLocalizedString("Add Bookmark",
                                               comment: "Accessibility label for button to add a bookmark").localized
