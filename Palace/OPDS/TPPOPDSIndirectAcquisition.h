...
@interface TPPOPDSIndirectAcquisition : NSObject
...
indirectAcquisitions:(NSArray<TPPOPDSIndirectAcquisition *> *_Nonnull)indirectAcquisitions;

+ (instancetype _Nullable)indirectAcquisitionWithXML:(TPPXML *_Nonnull)xml;
