...
@objc public func TPPOPDSAttributeKeyStringIsActiveFacetSwift(_ string: String?) -> Bool {
...
@objc public func TPPOPDSAttributeKeyStringIsFacetGroupSwift(_ string: String?) -> Bool {
  guard let string = string else { return false }
...
@objc public func TPPOPDSAttributeKeyStringIsFacetGroupTypeSwift(_ string: String?) -> Bool {
  guard let string = string else { return false }
