...
@objc class LCPLibraryService: NSObject, DRMLibraryService {
  ...
  lazy var contentProtection: ContentProtection? = lcpService?
    .contentProtection(with: LCPPassphraseAuthenticationService())
  ...
  func canFulfill(_ file: URL) -> Bool {
    file.pathExtension.lowercased() == licenseExtension
  }
  ...
  @objc func fulfill(
    ...
    completion: @escaping (_ localUrl: URL?, _ error: NSError?) -> Void
