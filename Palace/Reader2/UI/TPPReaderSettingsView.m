...
@implementation TPPReaderSettingsView
...
- (instancetype)initWithWidth:(CGFloat const)width
{
  ...
  self.sansButton.backgroundColor = [TPPConfiguration backgroundColor];
  ...
  self.serifButton.backgroundColor = [TPPConfiguration backgroundColor];
  ...
  self.openDyslexicButton.backgroundColor = [TPPConfiguration backgroundColor];
  ...
  self.whiteOnBlackButton.backgroundColor = [TPPConfiguration readerBackgroundDarkColor];
  ...
  self.blackOnSepiaButton.backgroundColor = [TPPConfiguration readerBackgroundSepiaColor];
  [self.blackOnSepiaButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
  [self.blackOnSepiaButton setTitleColor:[TPPConfiguration mainColor]
                                forState:UIControlStateDisabled];
  ...
  self.blackOnWhiteButton.backgroundColor = [TPPConfiguration readerBackgroundColor];
  [self.blackOnWhiteButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
  [self.blackOnWhiteButton setTitleColor:[TPPConfiguration mainColor]
                                forState:UIControlStateDisabled];
  ...
  self.decreaseButton.backgroundColor = [TPPConfiguration backgroundColor];
...
- (void)setFontFace:(TPPReaderSettingsFontFace)fontFace
{
  _fontFace = fontFace;
...
- (void)didSelectSans
{
  self.fontFace = TPPReaderSettingsFontFaceSans;
...
{
  self.fontFace = TPPReaderSettingsFontFaceOpenDyslexic;
...
{
  self.colorScheme = TPPReaderSettingsColorSchemeWhiteOnBlack;
...
{
  self.colorScheme = TPPReaderSettingsColorSchemeBlackOnSepia;
...
{
  if (self.fontSize == TPPReaderSettingsFontSizeSmallest) {
    TPPLOG(@"Ignoring attempt to set font size below the minimum.");
    return;
  }
...
{
  if (self.fontSize == TPPReaderSettingsFontSizeXXXLarge) {
    TPPLOG(@"Ignoring attempt to set font size above the max.");
    return;
  }
