...
@objcMembers final class TPPWelcomeScreenViewController: UIViewController {
  ...
  func pickYourLibraryTapped() {
    ...
    let pickLibrary = {
      let listVC = TPPWelcomeScreenAccountList { account in
...
final class TPPWelcomeScreenAccountList: UIViewController, UITableViewDelegate, UITableViewDataSource {
