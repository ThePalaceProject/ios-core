...
class TPPRegistryDebuggingCell: UITableViewCell {
  ...
  @objc private func clear() {
    ...
    showAlert(title: "Configuration Updated", message: "Registry has been reset to default")
  }
  ...
  @objc private func set() {
    ...
    guard let text = inputField.text, !text.isEmpty else {
      showAlert(title: "Configuration Update Failed", message: "Please enter a valid server URL")
      return
    }
