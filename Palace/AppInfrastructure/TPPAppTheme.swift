@objcMembers final class TPPAppTheme: NSObject {
    ...
    static func themeColorFromString(name: String) -> UIColor {
    ...
    private static func colorFromHex(_ hex: Int) -> UIColor {
    ...
    private static func hex(_ theme: NYPLAppThemeColor) -> Int {
        switch theme {
        case .red:
            return 0xb9000d
        case .pink:
