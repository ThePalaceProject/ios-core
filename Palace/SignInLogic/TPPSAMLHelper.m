...
//                                            notificationWithName:NSNotification.TPPAppDelegateDidReceiveCleverRedirectURL
//                                            object:url
//                                            userInfo:nil];
...
//  TPPCookiesWebViewModel *model = [[TPPCookiesWebViewModel alloc]
//                                    initWithCookies:@[]
...
//
//  TPPCookiesWebViewController *cookiesVC = [[TPPCookiesWebViewController alloc]
//                                             initWithModel:model];
