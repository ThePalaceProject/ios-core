...
@interface TPPBook : NSObject

@property (nullable, nonatomic, readonly) NSArray<TPPOPDSAcquisition *> *acquisitions;
@property (nullable, nonatomic, readonly) NSString *authors;
@property (nullable, nonatomic, readonly) NSArray<TPPBookAuthor *> *bookAuthors;
...
/// properties.
+ (nullable instancetype)bookWithEntry:(nullable TPPOPDSEntry *)entry;
...
- (nonnull instancetype)bookWithMetadataFromBook:(nonnull TPPBook *)book;
...
/// relation, else @c nil.
- (nullable TPPOPDSAcquisition *)defaultAcquisitionIfBorrow;
...
/// relation, else @c nil.
- (nullable TPPOPDSAcquisition *)defaultAcquisitionIfOpenAccess;
