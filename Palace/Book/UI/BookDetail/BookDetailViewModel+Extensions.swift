...
//      self.book = newBook
//      self.state = self.registry.state(for:  self.book.identifier)
//    }
//  }
//
//  @MainActor
...
//      guard let self else { return }
//
//      self.downloadProgress = self.downloadCenter.downloadProgress(for: self.book.identifier)
//      let info = self.downloadCenter.downloadInfo(forBookIdentifier: self.book.identifier)
