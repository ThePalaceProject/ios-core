...
- (void)startDownloadForBook:(TPPBook *)book;
...
- (void)startBorrowForBook:(TPPBook *)book attemptDownload:(BOOL)shouldAttemptDownload borrowCompletion:(void (^)(void))borrowCompletion;
...
///          @c -[TPPBookRegistry @c performWithAccount:block:].
...
- (TPPMyBooksDownloadInfo *)downloadInfoForBookIdentifier:(NSString *)bookIdentifier;
