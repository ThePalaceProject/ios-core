...
//      }
//    case .holdingFrontOfQueue:
//      buttons.append(contentsOf: [.get, .remove])
//    case .downloadNeeded:
//      buttons.append(.download)
//      if book.requiresAuthForReturnOrDeletion() {
//        buttons.append(.return)
//      } else {
//        buttons.append(.remove)
//      }
...
//    case .downloadFailed:
//      buttons.append(contentsOf: [.cancel, .retry])
//    case .unsupported:
//      return []
//    }
//
//    // Ensure we correctly determine whether a book supports deletion
//    if !book.supportsDeletion(for: self) {
//      buttons.removeAll { $0 == .return || $0 == .remove }
//    }
//
//    return buttons
//  }
