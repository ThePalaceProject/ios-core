...
## Version: 7.0.0 → 8.0.0 → 10.0.0 | App: Palace iOS | Date: 2026-04-06
...
### v10.0.0 Retest Results (2026-04-06)

| Issue | v10 Status | Notes |
|-------|-----------|-------|
...
| #4 Screenshots too large | **Fixed in v8** | `quality` param: `thumbnail` (25%), `standard` (50%), `full` |
| #5-7 Assertion/wait/indices | **Still open** | No changes |
| #16 Replay parameterization | **FIXED in v10** | `--var KEY=VALUE` for `${VAR}` substitution in replays |
| New (v8): WDA backend | Available | `specterqa-ios wda` — WebDriverAgent for headless CI |
| CI suite | **13/13 PASS** | No regressions v8 → v10 |
